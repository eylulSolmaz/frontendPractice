...
/* Bilgilerden Bilgi componentine propsla göndererek yapmayı deneyelim.
Bilgiler componentine eklemeler yaparak sayfamızı toparlayacağız. */
  ...
  return (
    <Card style={{ width: "18rem" }}>
      ...
      <Card.Body>
        ...
        <Button variant="primary" onClick={sonraki}>
          Next
        </Button>
        <Button variant="success" onClick={karisik}>
          Random
        </Button>
        <Button variant="secondary" onClick={onceki}>
          Prev
        </Button>
      </Card.Body>
    </Card>
